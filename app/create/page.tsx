...
export default function CreatePin() {
    ...
    return (
        <main className="min-h-screen bg-transparent safe-bottom">
            <Navbar />
                ...
                <form onSubmit={handleSubmit} className="form-stack">
                    <div className="card-surface p-5 md:p-6">
                        <div className="field-group">
                            <p className="text-[10px] uppercase tracking-[0.3em] text-muted font-semibold">Media</p>
                            <div className="relative">
                                {file ? (
                                    <div className="relative aspect-square w-full rounded-[28px] overflow-hidden bg-[#FFF7F1] shadow-xl border border-[#EADDD2]">
                                        <img
                                    ...
                                    <label className="flex flex-col items-center justify-center aspect-square w-full rounded-[28px] border-2 border-dashed border-[#EADDD2] bg-[#FFF7F1] hover:bg-white hover:border-[#FF6A3D]/30 transition-all cursor-pointer group shadow-inner">
                    ...
                    <div className="card-surface p-5 md:p-6">
                        <div className="field-group">
                            <p className="text-[10px] uppercase tracking-[0.3em] text-muted font-semibold">Details</p>
                            <div className="relative">
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    ...
                                    className="input-premium pl-12 min-h-[160px] py-4 leading-relaxed"
                                />
                            </div>
                    ...
                    <div className="card-surface p-5 md:p-6">
                        <div className="form-footer">
                            <button
                                ...
                                className="w-full btn-premium py-5 text-sm font-bold uppercase tracking-widest shadow-xl shadow-[#FF6A3D]/20 disabled:opacity-30 active:scale-95"
                            >
                                {uploading ? 'Publishing to Chain...' : 'Publish Now'}
                            </button>

                            <p className="text-[10px] text-center text-muted px-6 leading-relaxed uppercase tracking-tighter font-bold">
